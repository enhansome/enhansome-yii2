...
* [Yii Framework 2.0 中文权威指南 ](https://github.com/yiisoft/yii2/tree/master/docs/guide-zh-CN) ⭐ 14,289 | 🐛 336 | 🌐 PHP | 📅 2026-09-23
...
* [humhub](https://github.com/humhub/humhub) ⭐ 6,745 | 🐛 811 | 🌐 PHP | 📅 2026-09-23：开源社交网络，以前说 Yii 1 现在迁移到 Yii2。
* [Fecshop](https://github.com/fancyecommerce/yii2_fecshop) ⭐ 5,259 | 🐛 4 | 🌐 PHP | 📅 2026-09-05 ：Fecshop 全称为 Fancy ECommerce Shop，是基于 PHP Yii2框架之上开发的一款优秀的开源电商系统。
...
* [dotplant2](https://github.com/DevGroup-ru/dotplant2) ⭐ 632 | 🐛 44 | 🌐 PHP | 📅 2020-09-14：来自俄罗斯的电子商务CMS
...
* [lulucms2](https://github.com/yiifans/lulucms2) ⭐ 192 | 🐛 6 | 🌐 JavaScript | 📅 2017-06-02 ：LuLu CMS2，模块化开发，集成强大的权限管理功能，非常适合二次开发
* [xiaoego.com](https://github.com/daixianceng/xiaoego.com) ⭐ 181 | 🐛 0 | 🌐 JavaScript | 📅 2018-02-12：xiaoego.com源码，校园O2O购物平台。
* [huajuan](https://github.com/callmez/huajuan) ⭐ 109 | 🐛 2 | 🌐 PHP | 📅 2017-04-17：Yii2 实现的问答,微信,文章系统 Demo
...
* [jamband/plusarchive.com](https://github.com/jamband/plusarchive.com) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-29：如果想在 Yii2 中使用 webpack，可以参考这个项目。
...
* [yii2tech/balance](https://github.com/yii2tech/balance) ⚠️ Archived：强大的钱包系统。
* [robregonm/yii2-pdf](https://github.com/robregonm/yii2-pdf) ⭐ 46 | 🐛 9 | 🌐 PHP | 📅 2019-08-02：把 HTML 渲染成 PDF。
...
* [CostaRico/yii2-images](https://github.com/CostaRico/yii2-images) ⭐ 159 | 🐛 56 | 🌐 PHP | 📅 2019-03-30：图片尺寸裁剪解决方案
* [zhuravljov/yii2-rest](https://github.com/zhuravljov/yii2-rest) ⭐ 118 | 🐛 3 | 🌐 PHP | 📅 2018-07-18 Yii2 REST 客户端
* [yii2-plugins-system](https://github.com/loveorigami/yii2-plugins-system) ⭐ 114 | 🐛 0 | 🌐 PHP | 📅 2019-03-12 Yii2 plugins system module with event manager and shortcodes as WordPress
* [yii2-notification-wrapper](https://github.com/loveorigami/yii2-notification-wrapper) ⭐ 76 | 🐛 3 | 🌐 PHP | 📅 2021-06-03 Yii2-notification-wrapper module renders a message from session flash (with ajax, pjax support and etc.) through Growl, Noty, Toastr and more libraries
* [Chiliec/yii2-vote](https://github.com/Chiliec/yii2-vote) ⭐ 69 | 🐛 5 | 🌐 PHP | 📅 2026-01-04：提供点赞的模块
* [myweishanli/yii2-extjs-rbac](https://github.com/myweishanli/yii2-extjs-rbac) ⭐ 61 | 🐛 3 | 🌐 PHP | 📅 2016-07-15：Yii2 ExtJs5 RBAC+ACL 权限管理系统
* [yii2mod/yii2-cashier](https://github.com/yii2mod/yii2-cashier) ⭐ 45 | 🐛 7 | 🌐 PHP | 📅 2022-12-22：帮你处理付费订阅棘手问题，比方说订阅专栏一个月/一年等。
* [yiier/yii2-rbac](https://github.com/yiier/yii2-rbac) ⭐ 17 | 🐛 0 | 🌐 PHP | 📅 2020-07-19: 又一个 RBAC 模块
* [codemix/yii2-bs3activeform](https://github.com/codemix/yii2-bs3activeform) ⭐ 10 | 🐛 0 | 🌐 PHP | 📅 2014-10-30 :Yii2 表单增强模块，有[在线 Demo](http://codemix.github.io/yii2-bs3activeform/index.html)。
* [yiier/yii2-humans-log](https://github.com/yiier/yii2-humans-log) ⭐ 6 | 🐛 0 | 🌐 PHP | 📅 2020-02-14: 人类能看得懂的操作日志
* [yii2-setting](https://github.com/funson86/yii2-setting) ⭐ 5 | 🐛 4 | 🌐 PHP | 📅 2015-02-06：常见的在后台设置,可以使用在任何地方

## Widgets 小部件

* [kop/yii2-scroll-pager](https://github.com/kop/yii2-scroll-pager) ⭐ 178 | 🐛 46 | 🌐 PHP | 📅 2023-12-08：瀑布滚动翻页
...
* [lichunqiang/yii2-sweet-submit](https://github.com/lichunqiang/yii2-sweet-submit) ⭐ 27 | 🐛 0 | 🌐 PHP | 📅 2017-08-12：[sweetalert](https://github.com/t4t5/sweetalert) ⭐ 22,254 | 🐛 200 | 🌐 TypeScript | 📅 2023-04-15一个漂亮的弹出框
* [yii2-ajaxform](https://github.com/lichunqiang/yii2-ajaxform) ⭐ 21 | 🐛 0 | 🌐 PHP | 📅 2019-05-08：通过ajax提交表单

## Extension 扩展

* [zhuravljov/yii2-queue](https://github.com/zhuravljov/yii2-queue) ⭐ 1,063 | 🐛 75 | 🌐 PHP | 📅 2026-09-22：有望成为官网异步扩展的队列
* [yii2-imagine](https://github.com/yiisoft/yii2-imagine) ⭐ 286 | 🐛 7 | 🌐 PHP | 📅 2026-09-20：图片处理，缩略图生成
...
* [lichunqiang/yii2-swagger](https://github.com/lichunqiang/yii2-swagger) ⭐ 153 | 🐛 0 | 🌐 PHP | 📅 2026-01-19：Yii2 结合 [swagger](http://swagger.io/) 让写 API 文档不再是难事。[Demo 地址](https://github.com/lichunqiang/yii2-swagger-demo) ⭐ 60 | 🐛 1 | 🌐 PHP | 📅 2017-10-11
* [moonlandsoft/yii2-phpexcel](https://github.com/moonlandsoft/yii2-phpexcel) ⭐ 138 | 🐛 26 | 🌐 PHP | 📅 2023-08-31：导出 Excel
* [alexandernst/yii2-device-detect](https://github.com/alexandernst/yii2-device-detect) ⭐ 135 | 🐛 2 | 🌐 PHP | 📅 2020-09-02：获取访问网站的设备信息。
* [zhuzixian520/yii2-meilisearch](https://github.com/zhuzixian520/yii2-meilisearch) ⭐ 117 | 🐛 0 | 🌐 PHP | 📅 2022-02-21：Yii2 的 MeiliSearch 扩展，一款轻量级restful管理风格的搜索引擎
* [zelenin/yii2-semantic-ui](https://github.com/zelenin/yii2-semantic-ui) ⚠️ Archived：Yii2 封装 [Semantic UI](http://semantic-ui.com/)
* [hellowearemito/yii2-sentry](https://github.com/hellowearemito/yii2-sentry) ⭐ 91 | 🐛 8 | 🌐 PHP | 📅 2020-02-01： 收集日志神器——[Sentry](https://getsentry.com/) 的 Yii2 扩展。
* [jamband/yii2-schemadump](https://github.com/jamband/yii2-schemadump) ⚠️ Archived：用命令的方式对现有的数据库（SQL）生成数据库迁移（migrate）代码，内有 gif 演示。
* [yii2-smser](https://github.com/daixianceng/yii2-smser) ⭐ 86 | 🐛 1 | 🌐 PHP | 📅 2018-02-11：国内短信扩展
* [windhoney/yii2-rest-rbac](https://github.com/windhoney/yii2-rest-rbac) ⭐ 81 | 🐛 1 | 🌐 PHP | 📅 2023-08-17：Yii2前后分离，权限管理rbac--rest接口方式
* [yii2-beanstalk](https://github.com/udokmeci/yii2-beanstalk) ⭐ 70 | 🐛 5 | 🌐 PHP | 📅 2021-05-21：beanstalk 队列
* [yii2-echarts](https://github.com/daixianceng/yii2-echarts) ⭐ 69 | 🐛 2 | 🌐 PHP | 📅 2020-04-14：Yii2 ECharts扩展
* [DenisOgr/yii2-cronjobs](https://github.com/DenisOgr/yii2-cronjobs) ⭐ 47 | 🐛 7 | 🌐 PHP | 📅 2021-04-16：用系统计划任务来每分钟运行这个PHP计划任务，然后你程序的计划任务的调用就写在 cron 这个控制器里就可以了。
...
* [pingpp-yii2](https://github.com/idarex/pingpp-yii2) ⚠️ Archived：Yii2 化 Ping++ SDK
* [Hzhihua/yii2-dump](https://github.com/Hzhihua/yii2-dump) ⭐ 18 | 🐛 3 | 🌐 PHP | 📅 2018-05-02：用命令行的方式自动对现有的数据库（SQL）生成数据库迁移（migrate）文件，内有预览图。
* [yii2-qiniu](https://github.com/dcb9/yii2-qiniu) ⚠️ Archived：集成七牛的 SDK
* [zhuzixian520/yii2-api-doc](https://github.com/zhuzixian520/yii2-api-doc) ⭐ 16 | 🐛 0 | 🌐 PHP | 📅 2021-04-27：一个简单的 Yii2 注释生成 API 文档扩展
* [imyangjin/yii2-mysql-json](https://github.com/imyangjin/yii2-mysql-json) ⭐ 13 | 🐛 0 | 🌐 PHP | 📅 2018-12-12：扩展Yii2的ActiveRecord和ActiveQuery支持mysql json格式。使mysql json字段的操作和yii2无缝对接，使用更加简单。
* [yii2-yunpian](https://github.com/dcb9/yii2-yunpian) ⚠️ Archived：一个基于 Yii2 的短信 SDK
* [yiier/yiier-return-url](https://github.com/yiier/yiier-return-url) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2020-02-17：登录之后自动跳转登录之前的页面。
* [imanilchaudhari/yii2-rrssb](https://github.com/imanilchaudhari/yii2-rrssb) ⭐ 6 | 🐛 0 | 🌐 PHP | 📅 2024-05-03：分享到社交网络（主要是针对国外一些网站）。
* [yiier/yii2-smser](https://github.com/yiier/yii2-smser) ⭐ 5 | 🐛 0 | 🌐 PHP | 📅 2018-06-14: 发短信
* [yiier/yii2-action-store](https://github.com/yiier/yii2-action-store) ⭐ 4 | 🐛 0 | 🌐 PHP | 📅 2020-04-19: 让你不再为点赞、收藏等烦恼的扩展。
* [yiier/yii2-notification](https://github.com/yiier/yii2-notification) ⭐ 4 | 🐛 0 | 🌐 PHP | 📅 2021-08-31: 管理通知
...
* [dmstr/yii2-adminlte-asset](https://github.com/dmstr/yii2-adminlte-asset) ⭐ 1,119 | 🐛 17 | 🌐 PHP | 📅 2025-10-20：大名鼎鼎的 [AdminLTE](https://github.com/almasaeed2010/AdminLTE) ⭐ 45,614 | 🐛 3 | 🌐 Astro | 📅 2026-09-10 开源后台，我现在很多后台就用这个。配合[Yii2 使用 AdminLTE 模板](http://www.getyii.com/topic/564)教程使用更佳。
...
* [paulzi/yii2-nested-intervals](https://github.com/paulzi/yii2-nested-intervals) ⭐ 28 | 🐛 0 | 🌐 PHP | 📅 2018-08-06：数结构分类的行为、层级分类行为。
* [cornernote/yii2-softdelete](https://github.com/cornernote/yii2-softdelete) ⭐ 23 | 🐛 1 | 🌐 PHP | 📅 2017-09-13：软删除（伪删除）

## Helpers 助手

* [kartik-v/yii2-helpers](https://github.com/kartik-v/yii2-helpers) ⭐ 89 | 🐛 0 | 🌐 PHP | 📅 2024-05-02：[HTML](http://demos.krajee.com/helper-functions/html) 和 [枚举](http://demos.krajee.com/helper-functions/enum)的 helper
* [DevGroup-ru/yii2-tag-dependency-helper](https://github.com/DevGroup-ru/yii2-tag-dependency-helper) ⭐ 32 | 🐛 0 | 🌐 PHP | 📅 2017-09-22：非常棒的缓存设计方法，具体实现可以参考 [dotplant2](https://github.com/DevGroup-ru/dotplant2) ⭐ 632 | 🐛 44 | 🌐 PHP | 📅 2020-09-14 代码。
* [xinnianq/yii2-routes](https://github.com/xinnianq/yii2-routes) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2018-03-19 ：获取yii2项目所有路由，方便权限控制
...
* [魏曦的 Yii2.0 视频教程](http://i.youku.com/weixistyle) 与 [源码 michaelweixi/Yii2Blog](https://github.com/michaelweixi/Yii2Blog) ⭐ 45 | 🐛 1 | 🌐 PHP | 📅 2017-02-16
